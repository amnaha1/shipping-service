<?php  
     session_start();
     define("APPURL","http://localhost/shipping-service");
...
<html lang="en">
  <head>
    ...
    <title>shipping servies</title>
  </head>
  <body>

    <nav class="navbar navbar-expand-lg navbar-light bg-dark" >
    <div class="container" style="margin-top: none">
        <a class="navbar-brand  text-white" href="<?php echo APPURL; ?>">shipping service</a>
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="<?php echo APPURL; ?>/user-info/user-info.php">order status</a></li>
